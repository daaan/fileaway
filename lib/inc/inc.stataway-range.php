...
$begin_input = '<input type="text" id="stataway-fsb" name="stataway-fsb" class="stataway-datepicker" value="' . date(
        'Y-m-d',
        strtotime( $begin )
    ) . '"/>';
$end_input   = '<input type="text" id="stataway-fse" name="stataway-fse" class="stataway-datepicker" value="' . date(
        'Y-m-d',
        strtotime( $end )
    ) . '"/>';
$heading     =
