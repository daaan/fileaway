...
$thefiles .=
    ...
    "<a href='javascript:' data-disabled=\"" . __( 'Disabled', 'file-away' ) . "\" data-enabled=\"" . __(
        'Enabled',
        'file-away'
    ) . "\" " .
    ...
    "</select>" .
    "<span id='ssfa-bulk-action-engage-$uid' class='ssfa-bulk-action-engage'>" . _x(
        'File Away',
    ...
    "data-selectall=\"" . __( 'Select All', 'file-away' ) . "\" data-clearall=\"" . __( 'Clear All',
        'file-away' ) . "\" /> " .
