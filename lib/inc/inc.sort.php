...
if ( ! $limit ) {
    if ( phpversion() < '5.4' ) {
        array_multisort( $rawnames, SORT_ASC, SORT_STRING, $links, $locs, $exts, $fulls, $dirs, $times, $dynamics );
    } else {
        array_multisort( $rawnames, SORT_ASC, SORT_NATURAL, $links, $locs, $exts, $fulls, $dirs, $times, $dynamics );
    }
    ...
    if ( phpversion() < '5.4' ) {
        array_multisort( $rawnames, SORT_DESC, SORT_STRING, $links, $locs, $exts, $fulls, $dirs, $times, $dynamics );
    } else {
        array_multisort( $rawnames, SORT_DESC, SORT_NATURAL, $links, $locs, $exts, $fulls, $dirs, $times, $dynamics );
    }
    array_splice( $rawnames, $limit );
}