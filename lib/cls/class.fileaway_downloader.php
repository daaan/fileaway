...
if ( ! class_exists( 'fileaway_downloader' ) ) {
    class fileaway_downloader {
        ...
        public function download() {
            if ( empty( $_REQUEST['fileaway_download'] ) ) {
                return;
            }
            $file = $this->decrypt( $_GET['fileaway'] );
            $file = fileaway_utility::urlesc( $file, true );
            if ( ! is_file( $file ) ) {
                die( 'Sorry. That file could not be found.' );
            }
            if ( ! wp_verify_nonce( $_GET['nonce'], 'fileaway-download' ) ) {
                die( 'Sorry. The download could not be verified.' );
            }
