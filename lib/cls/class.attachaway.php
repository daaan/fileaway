...
if (class_exists('fileaway_attributes') && !class_exists('attachaway')) {
    class attachaway extends fileaway_attributes
    {
        ...
        public function sc($atts)
        {
            ...
            extract(
                $this->correctatts(
                    wp_parse_args($atts, $this->attachaway),
                    $this->shortcodes['attachaway'],
                    'attachaway'
                )
            );
            ...
            if ($type === 'table') {
                ...
                $filenamelabel = $filenamelabel ? $filenamelabel : _x(
                    'File&nbsp;Name',
                    'File Name Column',
                    'file-away'
                );
                $thefiles .=
                    ...
                    "<th class='ssfa-sorttype $theme-first-column' title=\""._x(
                        'Click to Sort',
                        'Column Sort Message',
                        'file-away'
                    )."\"".$typesort.">".
                    ...
                    "</th>";
                $thefiles .= $capcolumn
                    ? "<th class='ssfa-sortcapcolumn' title=\""._x(
                        'Click to Sort',
                        'Column Sort Message',
                        'file-away'
                    )."\"".$capsort.">".$capcolumn."</th>"
                    : null;
                $thefiles .= $descolumn
                    ? "<th class='ssfa-sortdescolumn' title=\""._x(
                        'Click to Sort',
                        'Column Sort Message',
                        'file-away'
                    )."\"".$dessort.">".$descolumn."</th>"
                    : null;
                $thefiles .= $size !== 'no'
